      ...
      <div className="mx-auto max-w-[1480px] px-5 md:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-5">
          {cats.map((c, i) => (
            ...
            >
              <div className="relative aspect-[5/4] md:aspect-auto md:h-[260px] overflow-hidden">
                {i === 0 && (
                  <div className="hidden md:block md:h-[540px]" aria-hidden />
                )}
                <Image
                  src={c.image}
                  alt={c.alt}
                ...
                <div className="absolute top-4 left-4 flex items-center gap-2">
                  ...
                  <span className="text-cream/95 text-xs uppercase tracking-widest">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                </div>
                <div className="absolute top-4 right-4 bg-cream/95 text-ink text-[0.7rem] uppercase tracking-widest px-2.5 py-1 rounded-full">
                  {c.fromPrice}
                </div>
                ...
                <div className="absolute bottom-5 left-5 right-5 text-cream">
                  ...
                  <p className="mt-1.5 text-sm leading-snug text-cream/85 max-w-[28ch]">
                    {c.blurb}
                  </p>
                </div>
              </div>

              <div className="px-5 py-4 md:py-5 flex flex-wrap gap-2 items-center">
                {c.picks.map((p) => (
                  <span
                    key={p}
